## Splunk JMX Modular Input v1.0

## Overview

This modular input provides the means to :
...
* listen for MBean notifications
...
Also refer to the modular inputs "docs" directory for :
...
As this is a modular input , you can configure your JMX inputs via Manager->DataInputs->JMX

You will need to configure your JMX config file, this is the config file where you specify JMX server(s), MBeans and MBean attributes/operations.
...
Any JMX modular input errors will get written to $SPLUNK_HOME/var/log/splunk/splunkd.log

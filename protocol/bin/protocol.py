'''
Wrapper Script for the Protocol Modular Input
...
JAVA_MAIN_CLASS = 'com.splunk.modinput.protocol.ProtocolModularInput'
MODINPUT_NAME = 'protocol'
...
def run_java():
    ...
    java_args = [ JAVA_EXECUTABLE, "-classpath",CLASSPATH,"-Xms128m","-Xmx256m","-Dsplunk.securetransport.protocol="+SECURE_TRANSPORT,JAVA_MAIN_CLASS]
